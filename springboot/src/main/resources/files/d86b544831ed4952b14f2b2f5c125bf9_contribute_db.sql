...
CREATE TABLE `paper`  (
  ...
  `review` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '审稿回复',
  `author` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL  COMMENT '作者',
  `file_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '下载地址',
  ...
  `submit_date` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '提交稿件时间',
  `specialist_id` int(10) NULL DEFAULT NULL COMMENT '审稿人(专家)ID',
  `check_date` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '审稿时间',
  `status` int(2) DEFAULT 0 COMMENT '稿件分配状态',
  `status1` int(2) DEFAULT 0 COMMENT '稿件审核状态',
...
CREATE TABLE `user`  (
  ...
  `id_card` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户身份证信息',
  ...
  `role` int(3) NULL DEFAULT 1 COMMENT '角色(1是投稿人2是审稿人3是管理员)',
