    ...
    <div style="width: 400px; margin: 50px auto">
      ...
      >
        ...
        <el-form-item label="类别" prop="category">
          <el-select v-model="form.category" class="m-2" placeholder="请选择审稿人类别">
            <el-option
        ...
        <el-form-item
          ><el-button type="text" @click="$router.push('/reviewer')"
            >&lt;&lt;返回
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sex: [{ required: true, message: "选择不能为空", trigger: "blur" }],
