  ...
  <div style="display: flex; margin-left: 50px; margin-top: 50px">
    ...
    >
      ...
      <el-table-column>
        ...
        <el-button type="primary" @click ="form=scope2.row; show=true">详情</el-button>
        </template>
      </el-table-column>
      <el-table-column>
        <template #default="scope">
          <el-button type="primary" @click="deleteReviewer(scope.row.specialistId)"
            >删除</el-button
          >
        </template>
      </el-table-column>
  ...
  <div>
    <el-dialog title="审稿人详细信息" v-model="show" width="30%">
      <el-descriptions :column="1">
        <el-descriptions-item label="编号：">{{form.specialistId}}</el-descriptions-item>
        ...
        <el-descriptions-item label="电话：">{{form.phoneNumber}}</el-descriptions-item>
